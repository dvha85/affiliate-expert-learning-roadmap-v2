...
def audit_runtime_acceptance(root, matrix):
    ...
    if "artifactRegistryPublishFailure" not in source_text or "TestMissionM10GateDisclosesRegistryPublishUncertainty" not in source_text or "TestMissionM10AuthorizationDisclosesRegistryPublishUncertainty" not in source_text or "uncertain M11 registry append was not retained" not in m11_fault_text:
