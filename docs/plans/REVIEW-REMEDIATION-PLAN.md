...
portable output; M11 registry cùng CLI `m11-activate`, `m11-ledger-init` và
offline `m11-evaluate` bàn giao record/ledger/evaluation đã visible để resolver
...
ledger-init và evaluation. Đây là
