...
BR-13c đang triển khai/review: [HTTPS fixture đã ghim](../architecture/BR-13C-HTTPS-FIXTURE.md), baseline `e0896de`, nhánh `codex/br-13c-https-fixture`. Fetch host/ref/hash cố định, không redirect/proxy/URL tùy ý, timeout/size/status/DNS guard; parser → canonical history, retry/replay và ACK sau append. Dữ liệu synthetic, không affiliate source/proof. BR-13 cha IN_PROGRESS.
