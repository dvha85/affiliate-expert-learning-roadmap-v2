...
BR-18a đã triển khai và review, nội dung được bàn giao qua [PR #90](https://github.com/dvha85/affiliate-expert-learning-roadmap-v2/pull/90): [runbook deployment/recovery 24/7](../architecture/BR-18A-DEPLOYMENT-RECOVERY-RUNBOOK.md) yêu cầu runtime/resource limits, backup checksum, restore/replay, STOP drill và human review. Quyết định hiện tại ngày 21/09/2026 chọn macOS native để kiểm chứng trước, direct runtime Go 1.27/Node 24/n8n 2.38.1, dữ liệu synthetic/read-only, loopback và runtime/backup tách trên `$HOME/affiliate-lab`; về sau vẫn có thể chuyển cùng profile sang Windows + Ubuntu 24.04 LTS trong WSL2 (Hyper-V fallback). Xem [macOS decision record](../architecture/EVIDENCE-BR18A-MACOS-LOCAL-LAB-20260921.md) và [Windows deployment decision](../architecture/EVIDENCE-BR18A-WINDOWS-ALWAYS-ON-LAB-20260921.md). Chưa có run record trên macOS hoặc Windows target/backup host được vận hành nên evidence vẫn UNVERIFIED.
