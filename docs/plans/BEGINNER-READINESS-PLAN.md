...
- Ngày lập: 05/09/2026.
- Trạng thái: IN_PROGRESS — BR-06a và BR-03c.1–c.8 đã merge (#27–#36); BR-03c.8b M11 chain audit đang triển khai; BR-06b chờ chương trình/kênh, BR-03c tổng thể chưa hoàn thành.
...
| BR-03 | A | Đồng bộ schema và validator output | P1 / M | — | IN_PROGRESS | Codex; BR-03a/b/c.1–c.8 đã merge (#36 `fa9b9db`); BR-03c.8b [M11 chain audit](../architecture/M11-CHAIN-AUDIT.md) đang triển khai, reviewer chủ repo chưa review; [audit/phần còn lại](../architecture/ARTIFACT-BOUNDARY-AUDIT.md) |
