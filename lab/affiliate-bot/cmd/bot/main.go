...
func main() {
	...
	if len(os.Args) > 1 && os.Args[1] == "advisor" {
		os.Exit(runAdvisor(os.Args[2:], os.Stdout, os.Stderr))
	}
	if len(os.Args) > 1 && os.Args[1] == "outcome" {
		os.Exit(runOutcomeStore(os.Args[2:], os.Stdout, os.Stderr))
	}
