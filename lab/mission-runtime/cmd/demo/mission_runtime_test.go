...
func TestM06NormalizesCanonicalObservation(t *testing.T) {
	...
	o,state:=NormalizeWatchObservation(r,"product-a"); if state!="NEW" { t.Fatalf("expected NEW got %s",state) }; if o.ObservationID=="" || o.SubjectID=="" || o.SourceURL=="" || o.EvidenceKind!="synthetic" || o.UseContext!="test" || o.ClaimKind!="fact" || o.Limitation=="" || o.ContentHash=="" { t.Fatalf("not canonical enough: %+v",o) }
