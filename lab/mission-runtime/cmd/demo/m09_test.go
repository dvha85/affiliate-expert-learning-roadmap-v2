...
func baseM09() (M09State,M09Context) {
	...
	return M09State{Intent:i,Policy:p,Approval:&a},M09Context{Now:"2026-09-03T08:00:00Z",Executor:ExecutorProfile{ExecutorID:"local_sandbox",AllowedActionTypes:[]string{"UPDATE_DRAFT"},AllowedHosts:[]string{"example.com"}},AlreadySucceeded:map[string]bool{}}
}
